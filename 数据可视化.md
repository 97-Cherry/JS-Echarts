...
<script>
    ...
    //绘制圆形
     ctx.beginPath();
     //绘制圆形的方法：x、y,r,起始弧度（360°=2*Math.PI）、结束的弧度,是否逆时针绘制
...
![image-20220712141945668](C:\Users\honor\AppData\Roaming\Typora\typora-user-images\image-20220712141945668.png)
...
- color：调色盘颜色列表
  ...
  ![image-20220612173403693](C:\Users\honor\AppData\Roaming\Typora\typora-user-images\image-20220612173403693.png)
  
  ```js
  //图表中的内容设置
  option = {
    color:['pink','blue','red','purple'],//可以用来设置线条的颜色，为一个数组的形式
    // 设置图表的tuli
    title: {
      text: 'Stacked Line'
    },
    // 设置鼠标作用于图中数据的显示效果，可以为axis 和item
    tooltip: {
      trigger: 'axis'
    },
    // 图例显示
    legend: {
      // series中存在了name值，纳米legend中数据值可以被删除
      data: ['Email', 'Union Ads', 'Video Ads', 'Direct', 'Search Engine']
    },
    // 调整网格区域与dom容器之间的大小，可以用来控制页面的大小设置
    grid: {
      left: '3%',
      right: '4%',
      bottom: '3%',
...
- ![image-20220612173915397](C:\Users\honor\AppData\Roaming\Typora\typora-user-images\image-20220612173915397.png)
...
![image-20220612200235279](C:\Users\honor\AppData\Roaming\Typora\typora-user-images\image-20220612200235279.png)
...
```js
    color: ['#00f2f1', '#ed3f35'],//两条线性定制的颜色如何进行设置
	series: [{
      name:'新增粉丝',
      data: [820, 932, 901, 934, 1290, 1330, 1320],
      type: 'line',
